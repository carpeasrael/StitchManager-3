...
/// All DB access goes through narrow Tauri commands — no plugin-sql exposure.
...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            commands::files::get_file_with_metadata,
            ...
            commands::projects::link_product_to_project,
            commands::projects::unlink_product_from_project,
            commands::projects::get_project_products,
            commands::projects::add_file_to_project,
            commands::projects::remove_file_from_project,
            ...
            // inventory commands removed (#118)
            ...
            commands::manufacturing::create_variant,
            commands::manufacturing::get_product_variants,
            commands::manufacturing::update_variant,
            commands::manufacturing::delete_variant,
            ...
            // time entry commands removed (#118)
            commands::manufacturing::create_step_def,
            commands::manufacturing::get_step_defs,
            commands::manufacturing::update_step_def,
            commands::manufacturing::delete_step_def,
            commands::manufacturing::set_product_steps,
            commands::manufacturing::get_product_steps,
            commands::manufacturing::create_workflow_steps_from_product,
            commands::manufacturing::get_workflow_steps,
            commands::manufacturing::update_workflow_step,
            commands::manufacturing::delete_workflow_step,
            commands::manufacturing::create_license,
            commands::manufacturing::get_licenses,
            commands::manufacturing::get_license,
            commands::manufacturing::update_license,
            commands::manufacturing::delete_license,
            commands::manufacturing::link_license_to_file,
            commands::manufacturing::unlink_license_from_file,
            commands::manufacturing::get_file_licenses,
            commands::manufacturing::get_expiring_licenses,
            // reservation/consumption/nachkalkulation commands removed (#118)
            commands::procurement::create_order,
            commands::procurement::get_orders,
            commands::procurement::get_order,
            commands::procurement::update_order,
            commands::procurement::delete_order,
            commands::procurement::add_order_item,
            commands::procurement::get_order_items,
            commands::procurement::delete_order_item,
            commands::procurement::record_delivery,
            commands::procurement::get_deliveries,
            commands::procurement::get_project_orders,
            commands::procurement::get_project_requirements,
            commands::procurement::suggest_orders,
            commands::manufacturing::create_inspection,
            commands::manufacturing::get_inspections,
            commands::manufacturing::update_inspection,
            commands::manufacturing::delete_inspection,
            commands::manufacturing::create_defect,
            ...
            commands::reports::export_bom_csv,
            // export_orders_csv removed (#118)
            commands::reports::export_project_full_csv,
            commands::reports::export_material_usage_csv,
            commands::reports::list_cost_rates,
            commands::reports::create_cost_rate,
            commands::reports::update_cost_rate,
            commands::reports::delete_cost_rate,
            commands::reports::get_cost_breakdown,
            commands::reports::calculate_selling_price,
            commands::reports::save_cost_breakdown,
            commands::reports::calculate_product_cost_cmd,
            commands::reports::link_license_to_project,
            commands::reports::unlink_license_from_project,
            commands::reports::get_project_licenses,
