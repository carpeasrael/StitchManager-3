...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            commands::manufacturing::reserve_materials_for_project,
            commands::manufacturing::release_project_reservations,
            commands::manufacturing::record_consumption,
            commands::manufacturing::get_consumptions,
            commands::manufacturing::delete_consumption,
            commands::manufacturing::get_nachkalkulation,
